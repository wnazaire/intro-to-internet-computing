    ...
    if (isset($_POST['user']))
    {
        ...
        else
        {
            ...
            else                                                //Username/Password match, start the session and redirect to The Wall
            {
                ...
                $_SESSION['user'] = $user;
                $_SESSION['pass'] = $token;
                header("Location: http://lamp.cse.fau.edu/~wnazaire2013/hw8/wall.php"); // Redirect browser
                die("Click to proceed to <a href='wall.php'>The Wall</a> if you aren't automatically redirected.");
            }
        }
    }
