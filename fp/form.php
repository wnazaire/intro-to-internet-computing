            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <h1 class="page-header">Upload a photo to post to The Wall</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div id="formParent" class="col-md-6 col-md-offset-3">
                        <form id="post2wall" class="form-horizontal" method="POST" action="wall.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-11">
                                    ...
                                    maxlength="30" size="30" value="" required placeholder="20 characters" autofocus>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox-inline">
                                    ...
                                    <input type="radio" name="filter" id="original" value="original" checked="checked" onclick="revertToOriginal();">
                                </div>
                            </div>
                            ...
                            <input type="button" id="submitPost" value="Upload image" class="btn btn-primary">
